...
bool vote(int voter, int rank, string name)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        //check if name of candidate is present
        //strcmp is checking for the name and camparing it
...
// eliminate candidates after some already eliminated
